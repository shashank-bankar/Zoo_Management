...
class ZoomanagementSystem:
        ...
        #SEARCH BY
                ...
                # Login =Button(self.root1,command=self.login,text="LOGIN",font=("times new roman",12,"bold"),bg="#c6c190",fg="white",relief=FLAT)
                # Login.place(x=700,y=700)
...
#Main Table
        def add_data(self):
                ...
                conn = mysql.connector.connect(host="localhost",user="root",password="SHA#27bankar7",database="zoo")
